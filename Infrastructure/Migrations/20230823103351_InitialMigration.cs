        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ipo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    marketCapitalization = table.Column<double>(type: "float", nullable: true),
                    name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    shareOutstanding = table.Column<double>(type: "float", nullable: true),
                    ticker = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    weburl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    logo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    finnhubIndustry = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LenderConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LenderConditions_CompanyTypes_CompanyTypeId",
                        column: x => x.CompanyTypeId,
                        principalTable: "CompanyTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LenderConditions_Lenders_LenderId",
                        column: x => x.LenderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LoanStatusId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccesTokenExpiryTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PasswordRecoveyToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PasswordRecoveyTokenCreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsBlocked = table.Column<bool>(type: "bit", nullable: false),
                    BlockEnd = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FiscalCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0A47E499-1E79-4E81-94DE-1BC68019CCCE", null, "Borrower", "BORROWER" },
                    { "4377AA5F-C7E7-45B9-A879-8409074EE9AB", null, "Admin", "ADMIN" },
                    { "ACEE1889-E154-4C90-91D4-5F8F396FC5B5", null, "Loan Officer", "LOAN OFFICER" }
                });
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "LoanStatusId",
                unique: true,
                filter: "[LoanStatusId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LenderConditions_CompanyTypeId",
                table: "LenderConditions",
                column: "CompanyTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_LenderConditions_LenderId",
                table: "LenderConditions",
                column: "LenderId");
