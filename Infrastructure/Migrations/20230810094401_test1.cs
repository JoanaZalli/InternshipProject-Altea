    ...
    public partial class test1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sole proprietorship (S.I.)", new DateTime(2023, 8, 10, 11, 44, 1, 174, DateTimeKind.Local).AddTicks(1627) },
                    { 2, "Other", new DateTime(2023, 8, 10, 11, 44, 1, 174, DateTimeKind.Local).AddTicks(1684) },
                    { 3, "Partnership limited by shares (p.l.sh.)", new DateTime(2023, 8, 10, 11, 44, 1, 174, DateTimeKind.Local).AddTicks(1686) },
                    { 4, "Limited partnership (l.p.)", new DateTime(2023, 8, 10, 11, 44, 1, 174, DateTimeKind.Local).AddTicks(1688) },
                    { 5, "Cooperative Society (c.s.)", new DateTime(2023, 8, 10, 11, 44, 1, 174, DateTimeKind.Local).AddTicks(1690) },
                    { 6, "General partnership (g.p.)", new DateTime(2023, 8, 10, 11, 44, 1, 174, DateTimeKind.Local).AddTicks(1692) }
                });
