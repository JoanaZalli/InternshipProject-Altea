...
{
    public class UpdateCompanyProfilesCommand : IRequest
    {
    }
    public class UpdateCompanyProfilesCommandHandler : IRequestHandler<UpdateCompanyProfilesCommand, Unit>
    {
        private readonly IFinhubService _finhubService;
        private readonly ICompanyProfileRepository _companyProfileRepository;

        public UpdateCompanyProfilesCommandHandler(IFinhubService finhubService, ICompanyProfileRepository companyProfileRepository)
        {
            _finhubService = finhubService;
            _companyProfileRepository = companyProfileRepository;
        }

        public async Task<Unit> Handle(UpdateCompanyProfilesCommand request, CancellationToken cancellationToken)
        {
